<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.Master" AutoEventWireup="true" CodeBehind="WfDepartamento.aspx.cs" Inherits="ProyectoMaritza_20160519_1705.Paginas.WfDepartamento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script src="../js/jquery-1.8.3.min.js"></script>
    <script src="../js/ajax_departamento.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="hidden_transac" runat="server" /> 
                     ...
                     <div class="panel-primary">                    
                      <div class="panel panel-body">
                           <div class="form-group row">
                                 <div class="col-sm-2"><asp:Label ID="lblNombreDepartamento" class="form-control-label"  runat="server" Text=" Nombre Departamento :"></asp:Label></div>
                                 <div class="col-sm-6"><asp:TextBox ID="txtNombreDepartamento" class="form-control"  runat="server"></asp:TextBox></div>
                           </div>
                           <div class="form-group row">
      ...
      <asp:GridView ID="grd_departamento" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="table footeable" GridLines="None" style="text-align:left">
                            <Columns>
